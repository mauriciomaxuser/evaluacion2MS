...
@section('contenido')
    ...
    <div class="d-flex gap-2 mb-3">
        <a href="{{ route('pilotos.create') }}" class="btn btn-success">Agregar Nuevo Piloto</a>
    </div>
            ...
            @foreach($pilotos as $pilotoTemporal)
                <tr>
                   ...
                   <td>
                        ...
                        <form action="{{ route('pilotos.destroy', $pilotoTemporal->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('¿Estás seguro de eliminar este piloto?');">
                            @csrf
                            @method('DELETE')
