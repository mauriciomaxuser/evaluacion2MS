...
<body>
    ...
    <a class="navbar-brand" href="/clientes">SIS GEO K2</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="/clientes">Home <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <a class="nav-link" href="/predios/nuevo">Registrar Predio</a>
        </li>
        <li class="nav-item">
